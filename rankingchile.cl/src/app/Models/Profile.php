...
class Profile extends Model
{
    ...
    /** D-044: public_id ULID se genera en creación si no se provee. */
    ...
    /** Badge derivado (AJUSTE-001): el verificado comunitario NO se persiste. */
    public function badge(): Attribute
    {
        return Attribute::get(fn () => match (true) {
            $this->verification_status === self::VERIFICATION_VERIFIED => 'verified',
